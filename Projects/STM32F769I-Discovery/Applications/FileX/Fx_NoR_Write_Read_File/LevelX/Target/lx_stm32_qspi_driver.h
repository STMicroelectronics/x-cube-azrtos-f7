...
#define LX_STM32_QSPI_FLASH_SIZE                  MX25L512_FLASH_SIZE
#define LX_STM32_QSPI_SECTOR_SIZE                 MX25L512_SUBSECTOR_SIZE
#define LX_STM32_QSPI_PAGE_SIZE                   MX25L512_PAGE_SIZE
#define LX_STM32_QSPI_DUMMY_CYCLES_READ_QUAD      MX25L512_DUMMY_CYCLES_READ_QUAD
#define LX_STM32_QSPI_BULK_ERASE_MAX_TIME         MX25L512_BULK_ERASE_MAX_TIME
#define LX_STM32_QSPI_SECTOR_ERASE_MAX_TIME       MX25L512_SUBSECTOR_ERASE_MAX_TIME
#define LX_STM32_QSPI_SR_WREN                     MX25L512_SR_WREN
#define LX_STM32_QSPI_SR_WIP                      MX25L512_SR_WIP
...
#define LX_STM32_QSPI_SR_QUADEN                   MX25L512_SR_QUADEN
#define LX_STM32_QSPI_DUMMY_CYCLES_READ_QUAD_IO   MX25L512_DUMMY_CYCLES_READ_QUAD_IO
#define LX_STM32_QSPI_CR_ODS                      MX25L512_CR_ODS
#define LX_STM32_QSPI_CR_ODS_15                   MX25L512_CR_ODS_15
#define LX_STM32_QSPI_QUAD_IN_FAST_PROG_CMD       QSPI_PAGE_PROG_4_BYTE_ADDR_CMD
#define LX_STM32_QSPI_ENTER_QUAD_CMD              ENTER_QUAD_CMD
#define LX_STM32_QSPI_ENTER_4_BYTE_ADDR_MODE_CMD  ENTER_4_BYTE_ADDR_MODE_CMD

#define LX_STM32_QSPI_VCR_NB_DUMMY                MX25L512_CR_NB_DUMMY
#define LX_STM32_QSPI_GET_STATUS_REG_CMD          READ_STATUS_REG_CMD
#define LX_STM32_QSPI_QUAD_INOUT_FAST_READ_CMD    QUAD_INOUT_FAST_READ_CMD
#define LX_STM32_QSPI_BULK_ERASE_CMD              BULK_ERASE_CMD
#define LX_STM32_QSPI_SECTOR_ERASE_CMD            SUBSECTOR_ERASE_4_BYTE_ADDR_CMD
#define LX_STM32_QSPI_READ_VOL_CFG_REG_CMD        READ_CFG_REG_CMD
#define LX_STM32_QSPI_WRITE_VOL_CFG_REG_CMD       WRITE_STATUS_CFG_REG_CMD
#define LX_STM32_QSPI_QUAD_OUT_FAST_READ_CMD      QSPI_READ_4_BYTE_ADDR_CMD
