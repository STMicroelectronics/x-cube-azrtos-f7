...
When an usb flash disk is plugged to STM32F769I-Discovery board, a Message will be displayed on the uart HyperTerminal showing  the Vendor ID and the Product ID of the attached device.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STM32F769I-Discovery board MB1225 Revision B-02
    boards and can be easily tailored to any other supported device
    and development board.

  - STM32F769I-Discovery Set-up:
    - Plug the USB key into the STM32F769I-Discovery board through 'USB micro A-Male  to A-Female' cable to the connector:
      - CN15 : to use USB High Speed OTG IP in High speed
